...
- **Stable job, dual income, no dependents?** → ~3 months is fine.
- **Variable income, freelancer, sole earner, or dependents?** → aim for **6–12 months**. More uncertainty = bigger cushion.
...
- A plain **savings account** (instant access),
- A **sweep-in FD** or short-term / liquid debt options (a bit more return, still quick to access).
