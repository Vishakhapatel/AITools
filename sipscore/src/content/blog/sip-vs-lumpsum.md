...
- **SIP** = investing a fixed amount at regular intervals. Matches how a salary lands — every month, on the dot.
- **Lumpsum** = investing a big amount all at once. Matches a windfall — a bonus, an old policy maturing, inheritance, selling something.
...
- **Invest the lumpsum, then run a monthly SIP on top** — your existing money compounds while fresh savings keep flowing in.
- **Stagger a big amount in gradually** if going all-in at once gives you anxiety — move it into equity over several months instead of one scary click.
