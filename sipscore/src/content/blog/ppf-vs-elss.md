...
- **This only matters under the old tax regime.** 80C deductions mostly don't apply under the new regime — so [sort out which regime you're on](/blog/new-vs-old-tax-regime/) *before* optimising 80C.
